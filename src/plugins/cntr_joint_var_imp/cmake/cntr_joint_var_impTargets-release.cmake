...
set_target_properties(cntr_joint_var_imp::cntr_joint_var_imp PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/cntr_joint_var_imp/libcntr_joint_var_imp.so"
  IMPORTED_SONAME_RELEASE "libcntr_joint_var_imp.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS cntr_joint_var_imp::cntr_joint_var_imp )
list(APPEND _IMPORT_CHECK_FILES_FOR_cntr_joint_var_imp::cntr_joint_var_imp "${_IMPORT_PREFIX}/cntr_joint_var_imp/libcntr_joint_var_imp.so" )
