...
set_target_properties(cntr_mux::cntr_mux PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/cntr_mux/libcntr_mux.so"
  IMPORTED_SONAME_RELEASE "libcntr_mux.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS cntr_mux::cntr_mux )
list(APPEND _IMPORT_CHECK_FILES_FOR_cntr_mux::cntr_mux "${_IMPORT_PREFIX}/cntr_mux/libcntr_mux.so" )
