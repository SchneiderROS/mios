...
set_target_properties(virtual_cube::virtual_cube PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/virtual_cube/libvirtual_cube.so"
  IMPORTED_SONAME_RELEASE "libvirtual_cube.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS virtual_cube::virtual_cube )
list(APPEND _IMPORT_CHECK_FILES_FOR_virtual_cube::virtual_cube "${_IMPORT_PREFIX}/virtual_cube/libvirtual_cube.so" )
